...
{
    public class BuildAudioInputMethodTests
    {
        ...
        public BuildAudioInputMethodTests()
        {
        ...
        [Fact]
        public async Task ShouldBuildConfigurationFileWithAudioInput()
        {
            string location = "C:/temp/";
            string configurationName = "sandbox.wsb";

            Configuration expectedRaw = new Configuration() { AudioInput = Enum.GetName(typeof(AudioInputOptions), AudioInputOptions.Disable) };
            ...
            IOptions options = new Options() { RootFilesDirectoryLocation = location, SandboxConfigurationFileName = configurationName, AudioInput = AudioInputOptions.Disable };
            ...
            sandboxConfigurationBuilder.BuildAudioInput();
